...
export const CV_PDF = path.join(rootDir, 'rendercv_output', 'Sepehr_Laal_CV.pdf')
...
export const RESUME_MATCHER_BACKEND_DIR = path.join(RESUME_MATCHER_DIR, 'apps', 'backend')
export const RESUME_MATCHER_FRONTEND_DIR = path.join(RESUME_MATCHER_DIR, 'apps', 'frontend')
...
export const RESUME_MATCHER_REPO = 'https://github.com/srbhr/Resume-Matcher.git'
